...
| Icon | File | Used in |
| --- | --- | --- |
| Activity | `activity.svg` | `src/app/leadership-views.tsx`, `src/app/tracker-view.tsx`, `src/components/ui/kit.tsx` |
| ArrowDown | `arrow-down.svg` | `src/app/leadership-views.tsx` |
| ArrowRight | `arrow-right.svg` | `src/app/tracker-view.tsx` |
| ArrowUp | `arrow-up.svg` | `src/app/leadership-views.tsx`, `src/components/chat/chat-ui.tsx`, `src/components/document-record/record-details-sheet.tsx` |
| ArrowUpDown | `arrow-up-down.svg` | `src/components/ui/kit.tsx` |
| ArrowUpRight | `arrow-up-right.svg` | `src/components/portfolio/tiles.tsx` |
...
| Building2 | `building-2.svg` | `src/app/leadership-views.tsx`, `src/components/document-record/record-details-sheet.tsx` |
...
| Coins | `coins.svg` | `src/app/leadership-views.tsx`, `src/app/tracker-view.tsx` |
...
| Inbox | `inbox.svg` | `src/app/tracker-view.tsx`, `src/components/ui/kit.tsx` |
| Info | `info.svg` | `src/app/overview/page.tsx`, `src/components/document-record/detail-record.tsx` |
| Layers | `layers.svg` | `src/app/leadership-views.tsx`, `src/app/tracker-view.tsx`, `src/components/document-record/record-details-sheet.tsx`, `src/components/ui/kit.tsx` |
...
| Minimize2 | `minimize-2.svg` | `src/components/app-shell.tsx` |
...
| Timer | `timer.svg` | `src/app/leadership-views.tsx` |
| TrendingUp | `trending-up.svg` | `src/app/leadership-views.tsx` |
| User | `user.svg` | `src/app/overview/page.tsx`, `src/app/tracker-view.tsx` |
| Users | `users.svg` | `src/components/document-record/record-details-sheet.tsx`, `src/components/ui/kit.tsx` |
| X | `x.svg` | `src/app/tracker-view.tsx`, `src/components/document-record/detail-record.tsx`, `src/components/document-record/markdown-modal.tsx`, `src/components/document-record/record-details-sheet.tsx` |
